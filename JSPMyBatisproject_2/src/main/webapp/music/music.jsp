<%@ page language="java" contentType="text/html; charset=UTF-8"
    ...
    <%
    	...
    	hashmap.put("fsArr",fsArr);
    	hashmap.put("ss",ss);
    	
    	List<MusicVO>list=MusicDAO.musicFindData(hashmap);
...
<div class="container">
<div class="row">
	<form action="music.jsp" method="post">
	<table class="table">
		<tr>
			<td>
				...
				<input type="text" name="ss" size=20 class="input-sm">앨범명
