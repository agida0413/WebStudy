...
public class BoardInsertServlet extends HttpServlet {
   ...
   protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
      ...
      out.write("<td width=85%><textarea rows=15 cols=50 name=content></textarea></td>");
      out.write("</tr>");
      out.write("<tr>");
      ...
      out.write("</table>");
      out.write("</form>");
      // form 안에 있는 <input>,<select>,<textarea>에 입력한 값만 넘어간다
      out.write("</center>");
      out.write("</body>");
      out.write("</html>");
   ...
   // 요청값을 받아서 처리해줄 때 => POST
   protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
      // 1. 전송된 값 <form> 받기 
      // 2. 한글이 변환이 안되면 글자가 다 깨진다
      ...
      // name=name , name=subject => name 이 구분자 
