...
public class BoardDAO {
   ...
   /*
      ...
      1. 미리 Connection 객체를 생성 
         => 몇개 => maxIdle=10
      2. 연결되어 있는 Connection의 주소를 얻어온다 
      3. Connection을 사용 
      4. 사용후에는 반드시 반환 
      ======================================
      1) 보안이 뛰어나다 (URL 주소 노출 없다)
      2) Connection 객체의 생성을 제어할 수 있다 
      3) 미리 연결했기 때문에 연결에 소모되는 시간을 줄일 수 있다 
      4) 웹 프로그램에 접근하는 인원이 많아도 쉽게 다운되지 않는다
   ...
   */
   ...
   // DBCP => 기능하고 관련이 없다 (연결,해제 에만 관여)
   // 기능 (게시판)
   // 1. 목록   ==> Read (SELECT) => 페이지 나누기(핵심) => 인라인뷰
